...
def init_potential_box(N, delta_x, wall_thickness_bohr_radii, potential_wall_height_hartree, V=None):
    if V is None:
    ...
    for x in range(0, N):
        for y in range(0, N):
            for z in range(0, N):
                ...
                V[x, y, z] += potential_wall_height_hartree * t / wall_thickness_bohr_radii
    return V
