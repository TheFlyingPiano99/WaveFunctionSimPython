...
/*
    Initializes a 3D Gaussian Wave Packet
*/
extern "C" __global__
...
)
{
    ...
    T_WF_FLOAT3 sigma = {sigma_x, sigma_y, sigma_z};
    ...
    wave_tensor[idx] = gaussian_wave_packet<T_WF_FLOAT, T_WF_FLOAT3>(sigma, r, r_0, k_0);
}
